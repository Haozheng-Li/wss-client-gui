...
class PyTitleBar(QWidget):
	...
	def add_menus(self, parameters):
		if parameters != None and len(parameters) > 0:
			for parameter in parameters:
				_btn_icon = set_resource.set_svg_icon(parameter['btn_icon'])
		...
		def change_ui():
			if _is_maximized:
				...
				self.maximize_restore_button.set_icon(
					set_resource.set_svg_icon("icon_restore.svg")
				)
			else:
				...
				self.maximize_restore_button.set_icon(
					set_resource.set_svg_icon("icon_maximize.svg")
				)
	...
	def setup_ui(self):
		...
		self.minimize_button = PyTitleButton(
			...
			text_foreground=self._text_foreground,
			radius=6,
			icon_path=set_resource.set_svg_icon("icon_minimize.svg")
		)
		...
		self.maximize_restore_button = PyTitleButton(
			...
			text_foreground=self._text_foreground,
			radius=6,
			icon_path=set_resource.set_svg_icon("icon_maximize.svg")
		)
		...
		self.close_button = PyTitleButton(
			...
			text_foreground=self._text_foreground,
			radius=6,
			icon_path=set_resource.set_svg_icon("icon_close.svg")
		)
