...
class PyLeftMenuButton(QPushButton):
	def __init__(
		...
		# APP PATH
		self._icon_path = set_resource.set_svg_icon(icon_path)
		self._icon_active_menu = set_resource.set_svg_icon(icon_active_menu)
		...
		self._set_icon_color = self._icon_color  # Set logo color
